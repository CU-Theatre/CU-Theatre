...
export const allClasses: CourseEvent[] = [ 
  ...
  },
  {
    ...
    rrule: new RRule({
      ...
      interval: 1,         // Кожного тижня
      byweekday: [RRule.SU],  // Вибираємо день тижня (наприклад, п'ятниця)
      dtstart: new Date(Date.UTC(2023, 8, 15, 17, 30, 0)), // Початок події
      until: new Date(Date.UTC(2025, 8, 15, 18, 30, 0)),   // Кінець повторення (опціонально)
    }),
  },
  {
    id: 3,
    ...
    rrule: new RRule({
      ...
      interval: 1,         // Кожного тижня
      byweekday: [RRule.WE],  // Вибираємо день тижня (наприклад, п'ятниця)
      dtstart: new Date(Date.UTC(2023, 8, 18, 13, 15, 0)), // Початок події
      until: new Date(Date.UTC(2025, 8, 18, 14, 15, 0)),   // Кінець повторення (опціонально)
    }),
  },
  {
    id: 4,
  ...
  },
  {
    ...
    rrule: new RRule({
      ...
      dtstart: new Date(Date.UTC(2023, 8, 19, 16, 0, 0)), // Початок події
      until: new Date(Date.UTC(2025, 8, 19, 17, 0, 0)),   // Кінець повторення (опціонально)
    }),
  },
  {
    id: 6,
  ...
  },
  {
    ...
    rrule: new RRule({
      ...
      dtstart: new Date(Date.UTC(2023, 8, 21, 11, 30, 0)), // Початок події
      until: new Date(Date.UTC(2025, 8, 21, 12, 30, 0)),   // Кінець повторення (опціонально)
    }),
  },
  {
    id: 8,
