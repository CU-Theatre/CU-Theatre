  ...
  return (
    <div className={classNames('burger-menu', {'menu-open': !isOpen})}>
      <div className="burger-menu__container">
        ...
        <img className="burger-menu__image burger-menu__image--sad" src={sadMask} alt="" />
        <nav className="burger-menu__navigation">
            ...
            {pages.map(page => (
              <li key={page.page} className='burger-menu__item'>
                <NavLink 
                  onClick={handleCloseMenu} 
                  to={page.link} 
                  className={({ isActive }) => cn('burger-menu__link', { 'nav-isActive': isActive })}
                >
                  {page.page}
                </NavLink>
              </li>
          ...
          <ul className="burger-menu__list burger-menu__list--icons">
            ...
            <li className='burger-manu__item'>
              <a href="#" className='burger-menu__icon burger-menu__icon--facebook'></a>
            </li>
          </ul>
          <Link to={'#'} className='burger-menu__button white-button'>Log in</Link>
        </nav>
        <img className="burger-menu__image burger-menu__image--happy" src={happyMask} alt="" />
      </div>
    </div>
  );
};